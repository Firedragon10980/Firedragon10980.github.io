...
function moveSnake() {
  ...
  */
  for (var i = snake.body.length - 1; i > 0; i--) {
    ...
    moveBodyAToBodyB(snakeSquareInFront, currentSnakeSquare);
...
function hasHitWall() {
  ...
  */
  if (snake.head.row < ROWS + 1 && -1 < snake.head.row && -1 < snake.head.column && snake.head.column < COLUMNS + 1) {
    return false;
  }
  else {
    return true;
